...
describe("class Person", function () {
  ...
  describe("#Constructor()", function () {
    ...
    it("should have properly set the [name] and [age] properties",
      function () {
  ...
  describe("#switchVisit(otherPerson)", function () {
    ...
    it("should invoke the visit function of the argument", function () {
      ...
      expect(person2.switchVisit(person1)).to.equal(`${person1.name} visited ${person2.name}`);
  ...
  describe("#greetAll(obj)", function () {
    context("when array of Person instances are passed in as arguments", function () {
